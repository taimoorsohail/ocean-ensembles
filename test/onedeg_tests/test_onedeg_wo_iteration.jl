...
@time simulation.output_writers[:transport] = JLD2Writer(ocean.model, transport_tuple;
                                                          ...
                                                          filename = "mass_transport_noiteration_onedeg_iteration",# * iteration_number,
...
@time simulation.output_writers[:surface] = JLD2Writer(ocean.model, outputs;
                                                 dir = output_path,
                                                 schedule = TimeInterval(50minutes),
                                                 filename = "global_surface_fields_noiteration_onedeg_iteration",# * iteration_number,
                                                 indices = (:, :, grid.Nz),
                                                 with_halos = false,
                                                 overwrite_existing = true,
...
@time simulation.output_writers[:ocean_tracer_content] = JLD2Writer(ocean.model, tracer_tuple;
                                                          dir = output_path,
                                                          schedule = TimeInterval(50minutes),
                                                          filename = "ocean_tracer_content_noiteration_onedeg_iteration",# * iteration_number,
                                                          overwrite_existing = true)
