...
using NumericalEarth.Diagnostics: Streamfunction
...
@info "Defining streamfunction diagnostics"

streamfunction_outputs = (
    streamfunction_rho_y = Streamfunction(ocean.model; type = "rho-y", ρmin = 1018, ρmax = 1038, Nρ = 128),
    streamfunction_z_rho = Streamfunction(ocean.model; type = "z-rho", ρmin = 1018, ρmax = 1038, Nρ = 128),
    streamfunction_horizontal = Streamfunction(ocean.model; type = "horizontal")
)

global_outputs = streamfunction_outputs
