...
grid = analytical_immersed_grid(underlying_grid; active_cells_map=false)
...
@time ocean = ocean_simulation(grid; Δt=1minutes, free_surface, timestepper = :SplitRungeKutta3, closure = RiBasedVerticalDiffusivity())
...
simulation = Simulation(coupled_model; Δt=10, verbose=false, stop_iteration=500)
